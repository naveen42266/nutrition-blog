            ...
            <div className='h-screen w-full'>
                ...
                <div className='absolute top-0 left-0 right-0'>
                    <div className='bg-[#F4F3EF] grid grid-cols-12 items-center pt-36 px-[75px]'>{/*px-[75px] */}
                        ...
                        <div className='col-span-6'><img className='' src="https://e1.pxfuel.com/desktop-wallpaper/611/76/desktop-wallpaper-chris-bumstead-athlete-video-shoot-chris-bumstead.jpg" alt="" /></div>
                    </div>
                    <Footer />
                </div>
            </div>
