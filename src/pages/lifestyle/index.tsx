                ...
                <div className='absolute top-0 left-0 right-0'>
                    <div className='bg-[#F4F3EF] px-[75px]'>
                        <div className='items-center pt-36' >
                            <div className="relative h-[500px]"><img className='h-[500px] w-full object-cover' loading="lazy" src="https://static.wixstatic.com/media/5305c5_7ddc0514eef84c0c987fe15b276ed12e~mv2_d_2448_3264_s_4_2.jpg/v1/fill/w_980,h_730,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/5305c5_7ddc0514eef84c0c987fe15b276ed12e~mv2_d_2448_3264_s_4_2.jpg" alt="" />
                                <div className='absolute top-[35%] left-[30%] right-[30%] z-10 bg-white py-[40px]'>
                                    <div className='text-5xl text-[#107070] font-bold text-center'>Lifestyle</div>
                                </div>
                            </div>
                        </div>
